(ns net.wikipunk.rdf.spdx-build
  ^{:base       "https://spdx.org/rdf/v3/Build/",
    ...
    :prefix     "spdx-build",
    :source     "resources/spdx/Build/Build.ttl"}
  {:owl/imports {:xsd/anyURI "https://spdx.org/rdf/v3/Core"},
   ...
   :rdfs/seeAlso {:xsd/anyURI "https://slsa.dev/provenance/v0.2"},
...
(def urn:uuid:f9a14c45-f4aa-5efc-8d83-fb73e51e0b38
  {:owl/imports {:xsd/anyURI "https://spdx.org/rdf/v3/Core"},
   :rdf/type :owl/Ontology,
   :rdfs/comment
   "The Build namespace defines concepts related to building of artifacts.",

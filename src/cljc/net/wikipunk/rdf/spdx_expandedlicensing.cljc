(ns net.wikipunk.rdf.spdx-expandedlicensing
  ^{:base       "https://spdx.org/rdf/v3/ExpandedLicensing/",
    ...
    :prefix     "spdx-expandedlicensing",
    :source     "resources/spdx/ExpandedLicensing/ExpandedLicensing.ttl"}
...
(def obsoletedBy
  {:db/ident :spdx-expandedlicensing/obsoletedBy,
   ...
   :rdfs/range :xsd/string,
   :sh/or [{:rdfs/domain #{:spdx-expandedlicensing/License
                           :spdx-expandedlicensing/LicenseAddition}}],
   :vs/term_status "Stable"})
...
(def subjectLicense
  {:db/ident :spdx-expandedlicensing/subjectLicense,
   ...
   :sh/or [{:rdfs/domain #{:spdx-expandedlicensing/OrLaterOperator
                           :spdx-expandedlicensing/WithAdditionOperator}}],
   :vs/term_status "Stable"})

(def urn:uuid:3132b87f-bfab-5253-8184-33f314f46fb5
  {:owl/imports #{{:xsd/anyURI "https://spdx.org/rdf/v3/Core"}
                  {:xsd/anyURI "https://spdx.org/rdf/v3/SimpleLicensing"}},
   :rdf/type :owl/Ontology,
   :rdfs/comment

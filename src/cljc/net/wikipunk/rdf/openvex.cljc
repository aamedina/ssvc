(ns net.wikipunk.rdf.openvex
  ^{:base       "https://openvex.dev/ns/v1#",
    ...
    :prefix     "openvex",
    :source     "resources/vex/openvex.ttl"}
...
(def Justification-ComponentNotPresent
  {:db/ident :openvex/Justification-ComponentNotPresent,
   ...
   :rdf/type #{:owl/NamedIndividual :openvex/Justification},
   :rdfs/comment
...
(def Status-Affected
  {:db/ident :openvex/Status-Affected,
   :rdf/type #{:openvex/Status :owl/NamedIndividual :owl/Class},
   :rdfs/comment
...
(def urn:uuid:45f94bba-2dab-5a29-ab03-a1d7c9bbdc2e
  {:owl/imports #{{:xsd/anyURI "https://spdx.org/rdf/v3/Core/"}
                  {:xsd/anyURI "https://spdx.org/rdf/v3/Security/"}
                  {:xsd/anyURI "https://spdx.org/rdf/v3/Software/"}},
   :owl/versionIRI {:xsd/anyURI "https://openvex.dev/ns/v1"},
